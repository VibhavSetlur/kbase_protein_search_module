...
build-test-script:
	...
	echo 'python3 -m nose --with-coverage --cover-package=$(SERVICE_CAPS) --cover-html --cover-html-dir=/kb/module/work/test_coverage --nocapture  --nologcapture test/unit_tests' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
