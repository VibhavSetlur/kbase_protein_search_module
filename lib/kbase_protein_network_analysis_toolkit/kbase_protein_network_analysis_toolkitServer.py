...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kbase_protein_network_analysis_toolkit.check_protein_existence,
                             ...
                             types=[dict])
        self.method_authentication['kbase_protein_network_analysis_toolkit.check_protein_existence'] = 'required'  # noqa
        self.rpc_service.add(impl_kbase_protein_network_analysis_toolkit.generate_protein_embedding,
                             ...
                             types=[dict])
        self.method_authentication['kbase_protein_network_analysis_toolkit.generate_protein_embedding'] = 'required'  # noqa
        self.rpc_service.add(impl_kbase_protein_network_analysis_toolkit.assign_family_fast,
                             ...
                             types=[dict])
        self.method_authentication['kbase_protein_network_analysis_toolkit.assign_family_fast'] = 'required'  # noqa
        self.rpc_service.add(impl_kbase_protein_network_analysis_toolkit.find_top_matches_from_embedding,
                             ...
                             types=[dict])
        self.method_authentication['kbase_protein_network_analysis_toolkit.find_top_matches_from_embedding'] = 'required'  # noqa
        self.rpc_service.add(impl_kbase_protein_network_analysis_toolkit.summarize_and_visualize_results,
                             ...
                             types=[dict])
        self.method_authentication['kbase_protein_network_analysis_toolkit.summarize_and_visualize_results'] = 'required'  # noqa
